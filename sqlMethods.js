module.exports = {
	...
	createTable: function() {'CREATE TABLE IF NOT EXISTS MENTORS(ID INT NOT NULL, FNAME VARCHAR(20) NOT NULL, LNAME VARCHAR(20) NOT NULL, CATEGORY VARCHAR(20) NOT NULL, DESCRIPTION VARCHAR(500),IMG VARCHAR(50), PRIMARY KEY (ID)); CREATE TABLE IF NOT EXISTS MENTORDATA(ID INT NOT NULL, USERNAME VARCHAR(20) NOT NULL, PWORD VARCHAR(20) NOT NULL, EMAIL VARCHAR(30), PHONE VARCHAR(15);'},
